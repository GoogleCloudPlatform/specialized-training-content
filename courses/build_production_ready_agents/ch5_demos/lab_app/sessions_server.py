...
async def list_examples():
    """List all examples in the Example Store."""
    examples = []
    try:
    ...
    async def event_generator():
        ...
        try:
            ...
            async for event in runner.run_async(
                ...
                # Comment this part out if you're having performance issues
                #==========================================================
                ...
                session_card = build_session_card_data(updated_session)
                yield f"data: {json.dumps(session_card)}\n\n"
                #==========================================================
